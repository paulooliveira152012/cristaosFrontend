...
const handleLogin = async (e) => {
  ...
  const apiUrl = process.env.NODE_ENV === 'production'
    ? "https://cristaosweb-e5a94083e783.herokuapp.com/api/users/login"
  ...
  return (
    <div>
      ...
      <div style={styles.loginContainer}>
        ...
        <p style={{marginTop: 20}}>Esqueceu a Senha? <Link style={{textDecoration: "none"}} to={"/passwordResetLink"}>redefinir aqui</Link></p>

        {/* Signup Link */}
        <div style={styles.signupSection}>
          <p>Não é um membro ainda?</p>
          <Link to="/signup" style={styles.link}>Criar conta</Link>
        </div>
